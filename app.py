...
# ------------------------
st.set_page_config(
    page_title="סוכן הניתוח המודיעיני: פתיחת פרוטוקולי שפת גוף",
    layout="centered",
)
...
# כותרת ואזהרה
# ------------------------
st.title("סוכן הניתוח המודיעיני: פתיחת פרוטוקולי שפת גוף")
st.caption("⚠️ כלי זה מיועד לניתוח כללי ואינו מחליף ייעוץ מקצועי.")
...
analyze_button = st.button("נתח שפת גוף עם Gemini")
